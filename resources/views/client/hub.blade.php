    ...
    <div class="mx-auto w-full max-w-5xl">
        <div class="hero-intro mb-5 sm:mb-6">
            ...
            <p class="mt-2 max-w-xl text-base text-ink/60 sm:text-lg">
                Escolha o modo — Solo, X1 ou Ao Vivo.
                @if ($questionCount === 0)
                    <span class="block mt-1 text-sm font-semibold text-coral">Aguardando perguntas neste quiz.</span>
                @endif
            </p>
        </div>

        <div class="grid gap-4 sm:grid-cols-3 sm:gap-5">
            <a href="{{ route('client.quiz', $client) }}" class="level-card level-card--sunshine group" style="--delay: 0ms">
                <div class="relative flex h-full flex-col">
                    ...
                    <p class="mt-3 flex-1 text-sm leading-relaxed text-white/80 sm:text-base">
                        Escolha a categoria e jogue sozinho ou revezando.
                    </p>
                    <span class="level-card__cta mt-6">Jogar Quiz →</span>
                </div>
            </a>

            <a href="{{ route('client.x1.hub', $client) }}" class="level-card level-card--ocean group" style="--delay: 40ms">
                <div class="relative flex h-full flex-col">
            ...
            <a href="{{ route('client.live.hub', $client) }}" class="level-card level-card--coral group" style="--delay: 80ms">
                <div class="relative flex h-full flex-col">
                    <span class="level-icon mb-5" aria-hidden="true">📡</span>
